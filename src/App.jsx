  ...
  return (
    <div className="vh" style={{ background: C.bg, fontFamily: FONT, display: "flex", justifyContent: "center" }}>
      <div ref={containerRef} className="vh" style={{ width: "100%", maxWidth: wide ? "none" : 420, display: "flex", flexDirection: "column", position: "relative", paddingTop: "env(safe-area-inset-top)" }}>
        ...
        <div style={{ display: "flex", justifyContent: wide ? "center" : "space-around", gap: wide ? 40 : 0, padding: wide ? "4px 24px 0" : "4px 8px 0", width: "100%", maxWidth: "none", margin: "0 auto" }}>
        ...
        {!wide ? (
          ...
          <div style={{ display: "flex", flexDirection: "column", alignItems: "center", gap: 18, padding: "0 24px", paddingBottom: short ? "calc(16px + env(safe-area-inset-bottom))" : "calc(4vh + env(safe-area-inset-bottom))" }}>
            <div ref={el => (seatEls.current[0] = el)} style={{ display: "flex", flexDirection: "column", alignItems: "center" }}>

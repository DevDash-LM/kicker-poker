...
-- auth.users row cascades to EVERY table keyed on the user id — profiles (and
-- through it friend_requests/friendships/room_invites), user_state, wallets,
-- wallet_ledger, solo_sessions, cosmetic_inventory, cosmetic_equipped,
-- daily_claims, quest_claims and mp_sessions all have `on delete cascade`, so
-- this one delete removes the whole account and all of its data.
--
...
-- signed in to delete your own account.
-- ---------------------------------------------------------------------------
